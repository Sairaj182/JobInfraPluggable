...
public class JobService{
    ...
    public String submit(com.sairaj.jobinfra.core.ExecutionType executionType, String handlerName, String webhookUrl, java.util.Map<String, String> webhookHeaders, String projectId, String payload){
        Job job = new Job(executionType, handlerName, webhookUrl, webhookHeaders, projectId, payload);
        registry.register(job);
        queue.enqueue(job);
        return job.getId();
    }
